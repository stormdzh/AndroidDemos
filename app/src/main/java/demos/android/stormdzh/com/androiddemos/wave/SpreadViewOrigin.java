...
public class SpreadViewOrigin extends View{
    ...
    public SpreadViewOrigin(Context context) {
        this(context,null,0);
    }

    public SpreadViewOrigin(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SpreadViewOrigin(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
